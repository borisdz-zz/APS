...
class NajgolemPodniza {
    ...
    String najdolgaZaednickaPodekvencaString(String x, String y) {
        int i, j;
        int N = x.length();
        int M = y.length();
...
public class Zad6 {
    public static void main(String[] args) {
        NajgolemPodniza nz = new NajgolemPodniza();

        nz.najdolgaZaednickaPodsekvencaDolzina("Hahahaha", "BLaHahahaBEhahaa");
    }
}
